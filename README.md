...
## **About**
Live preview web socket is an Apache Maven plugin to use alongside [**Beagle**](https://github.com/ZupIT/beagle).
...
Please read the [**code of conduct**](https://github.com/ZupIT/beagle-build-plugins/blob/master/CODE_OF_CONDUCT.md).
